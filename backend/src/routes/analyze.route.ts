...
const mimeValidator = isTest
  ? new HeuristicMimeValidator()
  : new FileTypeMimeValidator();

router.post('/analyze', upload.single('image'), makeAnalyzeController(visionService, mimeValidator));
